...
void loop() 
  ...
  void percursoFake() 
 {
   ...
   while (LO > 1880)
    {
     LO -= vel ;
     mySerial.print("[09,-26.242370,-48.64"+(String)LO+"]*");
   ...
   while (NS < 5150)
    {
     LO = 1880;
     NS += vel;
     mySerial.print("[09,-26.24"+(String)NS+",-48.641880]*");
     delay(random(1000, 1500));
    }
   ...
   while (LO < 4660)
    {
     NS = 5150;
     LO += vel;
     mySerial.print("[09,-26.245150,-48.64"+(String)LO+"]*");
     delay(random(1000, 1500));
    }
   ...
   while (NS > 2370)
    {
     NS -= vel;
     mySerial.print("[09,-26.24"+(String)NS+",-48.644660]*");
     delay(random(1000, 1500));
    }
}
